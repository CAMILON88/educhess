function engineGame(options) {
  ...
  setInterval(function() {
      ...
      if (game.game_over()) {
            ...
            z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Jaque Mate - Fin Del Juego';
            document.getElementsByClassName('status')[0].appendChild(z);
            
             $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
    ...
    function prepareMove() {
        ...
        if (!game.game_over()) {
            ...
            if(game.in_check()){
                ...
                var z = document.createElement('h4'); // is a node
    z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Jaque';
    document.getElementsByClassName('status')[0].appendChild(z);
     $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
            ...
            if(game.in_stalemate())
            {
                announced_game_over = true;
            var z = document.createElement('h4'); // is a node
            z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Quedaron en Tablas - Fin Del Juego';
            document.getElementsByClassName('status')[0].appendChild(z);
             $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
    ...
    return {
        ...
        setSkillLevel: function(skill) {
            ...
            {
                var z = document.createElement('h4'); // is a node
            z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Jugando Modo Facil';
            document.getElementsByClassName('status')[0].appendChild(z);
             $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
            ...
            {
                var z = document.createElement('h4'); // is a node
                z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Jugando Modo Medio';
                document.getElementsByClassName('status')[0].appendChild(z);
                 $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
            ...
            {
                var z = document.createElement('h4'); // is a node
                z.innerHTML = addZero(new Date().getHours()) + ":" + addZero(new Date().getMinutes()) + ":" + addZero(new Date().getSeconds()) + ' Jugando Modo Dificil';
                document.getElementsByClassName('status')[0].appendChild(z);
                 $('.status').animate({
                scrollTop: document.getElementsByClassName('status')[0].scrollHeight
             }, 500);
